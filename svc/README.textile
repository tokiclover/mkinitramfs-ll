@$Id: mkinitramfs-ll/svc/README.textile,v 0.13.0 2014/07/26 10:21:37 -tclover Exp $@

* sqfsdmount.initd:

Actually, without an initramfs one can get AUFS+squashfs working without an
issue if you make sure @/usr@ and @/$libdir@ get mounted as earlier as
possible with or without localmount help.

This init service will do the trick putting @/usr@ and @/$libdir@ first
