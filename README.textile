@$Header: mkinitramfs-ll/README.textile,v 0.10.3 2012/07/14 19:23:00 -tclover Exp $@
...
One can use something like @iroot=pool/root::zfs izfs=zva-sda:zvb-sdb,-f@. Notice that @izfs=@ argument
