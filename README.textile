@$Header: mkinitramfs-ll/README.textile,v 0.9.8 2012/07/05 14:37:48 -tclover Exp $@
...
dmraid software raid can be passed like @iraid=UUID=<uuid>+isw,dos@ for example.
