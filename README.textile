@$Header: mkinitramfs-ll/README.textile,v 0.12.8 2014/07/22 10:59:54 -tclover Exp $@
...
*IMPORTANT*: So either way, one should append @::zfs@ to @iroot@ argument for
unencrypted vdev(s);
or else, @izfs@ is required for encrypted vdev(s) or both for this case.
