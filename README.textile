@$Header: mkinitramfs-ll/README.textile,v 0.12.8 2014/07/02 16:13:54 -tclover Exp $@
...
Now one can add scripts to @modules@ of the initramfs root, or else in
...
line in mkinitramfs-ll.conf, the modules and module group file will be added!
...
Extra actions can be taken for with a _user script_ if needed.

KERNEL-COMMAND-LIE-ARG: @izram=4,4G:ext3@
DESCRIPTION: zram basic initialisation kernel command line argument
EXEMPLE: see above

Enter zram.1 module. This take of basic zram initialisation:
...
Just appand -M:zram -m:zram to mkinitramfs-ll.$shell to get support for this module.
