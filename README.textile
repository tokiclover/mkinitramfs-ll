@$Header: mkinitramfs-ll/README.textile,v 0.10.2 2012/07/13 16:20:36 -tclover Exp $@
...
* @crypt@     -> automaticaly generated with mkinitramfs-ll.$shell (dm-crypt module group)
* @lvm@       -> automaticaly generated with mkinitramfs-ll.$shell (device-mapper module group)
* @dmraid@    -> automaticaly generated with mkinitramfs-ll.$shell (dmraid module group)
* @mdadm@     -> automaticaly generated with mkinitramfs-ll.$shell (mdadm module group)
...
One can use something like @iroot=pool/root::zfs izfs=zpva-sda:zpvb-sdb,-f@. Notice that @izfs=@ argument
is required for crypted vdev(s). Do not forget to include zfs module or build an initramfs with something
like: @mkinitramfs-ll.$shell -a -f -y -Mzfs -mspl:znvpair:zcommon:zavl:zunicode:zfs -b:zpool:zfs@.
