@$Header: mkinitramfs-ll/README.textile,v 0.10.2 2012/07/13 16:16:00 -tclover Exp $@
...
h3. 10. ZFS support
One can use something like @iroot=pool/root::zfs izfs=zpva-sda:zpvb-sdb@. Notice that @izfs=@ argument
