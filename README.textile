@$Header: mkinitramfs-ll/README.textile,v 0.9.8 2012/07/06 08:18:39 -tclover Exp $@
...
@echo ARRAY <array> devices=/dev/sd?<opt> >> /etc/mdadm.conf@; or else, nothing for mdraid software raid.
