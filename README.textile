@$Header: mkinitramfs-ll/README.textile,v 0.13.6 2014/09/26 10:59:54 -tclover Exp $@
...
*IMPORTANT*: So either way, one should append @::zfs@ to @iroot@, or only @:zfs@
...
*IMPORTANT*: The @zfs@ suffix should be the 4th field for @iswap@ and @iresume@,
so append @::zfs@ to @swap:POOL/VOL::zfs@ which means that no signature is present in
this case; or else @file:POOL/VOL:sign:zfs@ when a signature is present and required. 
...
KERNEL-COMMAND-LIE-ARG: @izram=4,1G:4G-ext4@
