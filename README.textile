@$Header: mkinitramfs-ll/README,v 0.6.0 2012/05/23 12:00:57 -tclover Exp $@
...
VG in swap or resume VG or RAID array or LUKS PV, if not root group, to make sure the required volume is 
